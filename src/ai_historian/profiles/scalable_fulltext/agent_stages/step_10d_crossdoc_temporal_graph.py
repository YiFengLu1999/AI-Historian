...
TIMEBLOCK_STEP = int(os.getenv("AIH_TEMPORAL_GRAPH_TIMEBLOCK_STEP", "10"))
RUN_ROOT: Path
TIMEBLOCK_DIR: Path
SEQUENCE_DIR: Path
STEP_LABEL = os.getenv("AIH_TEMPORAL_GRAPH_STEP_LABEL", "Step10d")
REPORT_NAME = os.getenv(
    "AIH_TEMPORAL_GRAPH_REPORT_NAME",
    "step10d_temporal_graph_report.json",
)
...
def main() -> None:
    ...
    reporter = StepReporter(STEP_LABEL)
